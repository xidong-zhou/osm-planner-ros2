...
namespace osm_planner {
    ...
    namespace coordinates_converters {
        ...
        double WGS84Elipsoid::getDistance(double latitude1, double longitude1, double latitude2, double longitude2) {
            ...
            geometry_msgs::msg::Point p1 = getGeoPoint(latitude1, longitude1);
            geometry_msgs::msg::Point p2 = getGeoPoint(latitude2, longitude2);
        ...
        geometry_msgs::msg::Point WGS84Elipsoid::getGeoPoint(double latitude, double longitude){
