...
*/
	...
	void initialize(rclcpp::Node::SharedPtr& node);
         ...
         * @param lon - longitude
         */
        void setPositionFromGPS(const double lat, const double lon,const double yaw,bool flag);
         ...
         */
        void setPositionFromPose(const geometry_msgs::msg::Pose &pose);  //from odom
