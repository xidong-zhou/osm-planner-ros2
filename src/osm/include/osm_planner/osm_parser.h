...
namespace osm_planner {
	...
	rclcpp::Node::SharedPtr n ;
        ...
        void publishPoint(int pointID, int marker_type, double radius, geometry_msgs::msg::Quaternion orientation );
        void publishPoint(geometry_msgs::msg::Point point, int marker_type, double radius, geometry_msgs::msg::Quaternion orientation );
        void publishPoint(const OSM_NODE &node, int marker_type, double radius, geometry_msgs::msg::Quaternion orientation);
        void publishPoint(double latitude, double longitude, int marker_type, double radius, geometry_msgs::msg::Quaternion orientation);
        ...
        nav_msgs::msg::Path getPath(std::vector<int> nodesInPath); //get the XY coordinates from vector of IDs
    ...
    private:
        ...
        //publishers
        rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr position_marker_pub;
        rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr target_marker_pub;
        rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr path_pub;
        rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr refused_path_pub;
        
	rclcpp::Clock clock;
        //visualization msgs
        visualization_msgs::msg::Marker position_marker, target_marker;
